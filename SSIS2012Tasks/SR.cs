...
namespace Microsoft.SqlServer.IntegrationServices.Build
{
	...
	internal class SR
	{
        ...
        public static string CreatingEnvironment(string environment)
        {
            return Keys.GetString(Keys.CreatingEnvironment, environment);
        }

        public static string CreatingEnvironmentReference(string environment)
        {
            return Keys.GetString(Keys.CreatingEnvironmentReference, environment);
        }
		...
		public class Keys
		{
            ...
            public const string CreatingEnvironment = "CreatingEnvironment";
            
            public const string CreatingEnvironmentReference = "CreatingEnvironmentReference";
